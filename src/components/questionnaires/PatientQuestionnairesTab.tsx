...
export function PatientQuestionnairesTab({ patientId, encounterId, initialResponses }: Props) {
        ...
        <div className="space-y-3">
            ...
            {responses.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 gap-2 text-muted-foreground">
                    ...
                    <p className="text-sm">No questionnaire responses recorded</p>
                    <p className="text-xs text-muted-foreground/60">Use &quot;Start Questionnaire&quot; to fill PHQ-9, GAD-7, AUDIT-C, or intake forms.</p>
                </div>
            ) : (
